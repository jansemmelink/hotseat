...
func init() {
	...
	c := Config{
		...
		Port:           intDefault(os.Getenv("DB_PORT"), 3307),
		Username:       strDefault(os.Getenv("DB_USERNAME"), "hotseat"),
		Password:       strDefault(os.Getenv("DB_PASSWORD"), "hotseat"),
		Database:       strDefault(os.Getenv("DB_DATABASE"), "hotseat"),
